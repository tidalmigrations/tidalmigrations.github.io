...
- Determine transition types for each application (Tidal can provide [Transition Type Recommendations (6R)](transition-type-recommendations.html) based on interview and other assessment data).
