...
The way it works is very simple. The power of Nmap makes it possible to discover even those places which are often hard to reach.

With Nmap's powerful capabilities and good [documentation](https://nmap.org/book/host-discovery-find-ips.html) you can identify all the hosts you have running on your network, open ports, and running services.
