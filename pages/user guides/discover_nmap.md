...
3. Run Nmap with the flags of your choosing and save the output to an XML file. For example,
    ...
    ```
    [Go here to install Nmap](#installing-nmap).
...
You can find all the documentation on [Nmap's](https://nmap.org/) official site  and instructions for how to download based on your environment [download](https://nmap.org/download.html).
