...
2. Connect Tidal Tools and your Tidal account with [tidal login](https://guides.tidalmg.com/tidal-tools.html#login).
...
4. Run this Tidal Tools command to upload your previously generated Nmap output to your Tidal account 
    ...
    ```
5. Head over to your Tidal account! (https://<<account_name>>.tidalmg.com/#/discover/host_discovery)
