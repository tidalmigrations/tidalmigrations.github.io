...
{: .note }
We recommend you to use the [Ubuntu Server](#ubuntu-server-1804) image unless you want to you want to run Machine Stats on Windows.
...
{: .note }
This image comes only with the latest version of
