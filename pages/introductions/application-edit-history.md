...
The history drawer displays edits in chronological order. Each entry shows who made the change and when. If a single edit modified multiple attributes, a summary is shown with a sub-section of changes.
