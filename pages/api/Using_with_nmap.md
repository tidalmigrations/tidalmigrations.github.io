...
You can send the output generated by Nmap to the Tidal Migrations API in two ways. First, by using our CLI Tidal Tool [Instructions](https://guides.tidalmg.com/discover_nmap.html) and second, by sending the data to the API by using a service like Postman. 
